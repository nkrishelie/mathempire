...
\setlist[enumerate,1]{label = \arabic*., ref = \arabic*, leftmargin=0pt, itemsep=2pt+4pt-3pt}
...
\usepackage[papersize={165mm,235mm},centering, %marginparsep=8pt,marginparwidth=15mm,%
           % left=10mm,
            textwidth=135mm,nohead,top=15mm,bottom=20mm]{geometry}   %,showframe
...
\newcommand{\lektion}{\refstepcounter{lektion}
