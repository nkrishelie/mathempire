...
\usepackage{pscyr}
\renewcommand{\rmdefault}{fha} % Handbook font     % Основной шрифт текста
\renewcommand{\sfdefault}{ftx} % Textbook font     % Рубленый шрифт
\SetMathAlphabet{\mathsf}{normal}{T2A}{ftx}{m}{n}  % Рубленый шрифт для матем.
%\usepackage{booktabs}
\usepackage{colortbl}
\usepackage{xcolor}
%\usepackage{fontspec}
...
\titleformat{\chapter}[block]{}{}{}{\quad\hfill\Large\bfseries\MakeUppercase}%\sffamily
[\vspace{-20pt}\textcolor{darkred}{\hrule}\vspace{10mm}\thispagestyle{empty}]   % используется только для ненумерованных и литературы
\titleformat{\section}{\color{darkred}\Large\bfseries}{\thesection}{5pt}{\color{darkred}\Large\bfseries}
\titleformat{\subsection}{\color{darkGreen}\large\bfseries}{\thesubsection}{5pt}{\color{darkGreen}\large\bfseries}
\titleformat{\subsubsection}{\color{deepblue}\large\bfseries}{\thesubsubsection}{5pt}{\color{deepblue}\large\bfseries}
...
\vspace{10pt}
{\Huge\bfseries #2\isnotempty{#1}{\\[12pt]#1}{}}
\vspace{10mm}
\end{flushright}}
\chaptermark{#2\ #1}
\thispagestyle{empty}
...
\vbox{
\begin{flushright}
{\Large\bfseries ПРИЛОЖЕНИЕ\ \theapp}
\vspace{5pt}
\textcolor{darkred}{\hrule}
\vspace{10pt}
{\Huge\bfseries #2 \\[12pt] #1}
\vspace{10mm}
\end{flushright}}
\markboth{Приложение\ \theapp.\ #2\ #1}{ Приложение\ \theapp.\ #2\ #1}
\thispagestyle{empty}
}
...
\begin{minipage}{13mm}
\begin{flushleft}
\textcolor{white}{\Huge\phantom{Ï}A\phantom{j}}
\end{flushleft}
\end{minipage}}}
...
\end{center}
\end{minipage}}}
\renewcommand{\chaptermark}[1]{\markboth{\chaptername\ \thechapter.\ #1}{}} % колонтитулы глав
\renewcommand{\sectionmark}[1]{\markright{\thesection.\ #1}}                % колонтитулы секций
\renewcommand{\cftmarktoc}[1]{\markboth{Содержание}{Содержание}} % колонтитулы содержания
...
\fancyfoot[LE]{\makebox[4ex][l]{\bfseries\thepage}\;|\quad \leftmark} % номер страницы слева на четных
\fancyfoot[RO]{\rightmark\quad|\;\makebox[4ex][r]{\bfseries\thepage}} % номер страницы справа на нечетных
...
\setlength{\intextsep}{5pt}% used only by wrapfig
\newcommand{\adduprL}[1][]{
\refstepcounter{upr}
...
% Определение заголовков Уроков в тексте и сбор их в таблицу всех уроков
...
%  numberstyle=\tiny\color{gray},     % Стиль который будет использоваться для нумерации строк
  captionpos=t,
%  stepnumber=1,su)                   % Шаг между линиями. Если 1, то будет пронумерована каждая строка 
  numbersep=5pt,                  
...
\fancyfoot[LE]{\makebox[4ex][l]{\bfseries\thepage}\;|} % номер страницы слева на четных
\fancyfoot[RO]{|\;\makebox[4ex][r]{\bfseries\thepage}} % номер страницы справа на нечетных
...
\bibitem{Berger} Берже.М. Геометрия: Пер. с франц. --- М.: Мир, 1984.
...
\bibitem{Gelf} Гельфанд~И.~М. Лекции по линейной алгебре. --- М.:Наука, 1971.
...
\bibitem{zaris} Зарисский~О., Самюэль~П. Коммутативная алгебра. В двух томах. --- М.: ИИЛ, 1963.
\bibitem{Zorich} Зорич.В.А. Математический анализ. Часть I и Часть II. --- 6-е изд., дополн. --- М.:МЦНМО, 2012.
\bibitem{Klain} Клайн~М. Математика. Утрата определенности. --- М.: Мир, 1984.
...
\bibitem{KostrikinManin} Кострикин~А.~И., Манин~Ю.~И. Линейная алгебра и геометрия. Учебное пособие для вузов. --- 2-е изд., перераб. --- М.: Наука, 1986.
...
\bibitem{Pras} Прасолов~В.~В. Наглядная топология. --- 3-е изд., стереотип. --- М.:МЦНМО, 2012.
\bibitem{Reid} Рид~К. Гильберт. --- М.: Наука, 1977.
\bibitem{rudin} Рудин.~У. Основы математического анализа. --- М. <<Мир>>, 1976.
\bibitem{Savva} Савватеев~А.~В. Математика для гуманитариев. Живые лекции. --- М.:
